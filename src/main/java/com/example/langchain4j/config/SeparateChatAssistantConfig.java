...
import com.example.langchain4j.store.MongoChatMemoryStore;
...
public class SeparateChatAssistantConfig {
    ...
    public ContentRetriever contentRetrieverXiaozhi() {
        ...
        //并使用默认的文档解析器对文档进行解析
        Document document1 = FileSystemDocumentLoader.loadDocument("src/main/resources/knowledge/人工智能.md");
